    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4">
                <h2>Presentations</h2>
                <p>Presentations</p>
                <p><a href="./cs/presentations.html" role="button" class="btn btn-secondary">View details »</a></p>
            </div>
            <div class="col-md-4">
                <h2>Videos</h2>
                <p>Videos</p>
                <p><a href="./cs/videos.html" role="button" class="btn btn-secondary">View details »</a></p>
            </div>
            <div class="col-md-4">
                <h2>Exams</h2>
                <p>Exams</p>
                <p><a href="./cs/exams.html" role="button" class="btn btn-secondary">View details »</a></p>
            </div>
        </div>
    </div>
    <hr>
